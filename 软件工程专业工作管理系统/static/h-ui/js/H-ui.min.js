...
!function ($) {
    $.fn.Huispinner = function (options) {
        ...
        this.each(function () {
            ...
            that.append(str);
            var input = that.find(".input-text"), subtract = that.find(".subtract"), add = that.find(".add"), value = parseInt(input.val());
...
(function ($) {
    ...
    ColorPicker.prototype.updateColors = function (colors) {
        var $picker = this.$picker, $menu = this.$menu.empty(), options = this.options, colors = colors || this.colors, that = this;
        var bestLineCount = 0;
